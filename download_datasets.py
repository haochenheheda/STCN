...
os.system(Command(token, '1wUJq3HcLdN-z1t4CsUhjeZ9BVDb9YKLd', '../static/static_data.zip'))
...
os.system(Command(token, '198aRlh5CpAoFz0hfRgYbiNenn_K8DxWD', '../DAVIS/DAVIS-data.zip'))
...
os.system(Command(token, '1kiaxrX_4GuW6NmiVuKGSGVoKGWjOdp6d', '../DAVIS/2017/DAVIS-2017-trainval-480p.zip'))
...
os.system(Command(token, '1fmkxU2v9cQwyb62Tj1xFDdh2p4kDsUzD', '../DAVIS/2017/DAVIS-2017-test-dev-480p.zip'))
...
os.system(Command(token, '1JzIQSu36h7dVM8q0VoE4oZJwBXvrZlkl', '../DAVIS/2017/DAVIS-2017-scribbles-trainval.zip'))
...
os.system(Command(token, '13Eqw0gVK-AO5B-cqvJ203mZ2vzWck9s4', '../YouTube/train.zip'))
...
os.system(Command(token, '1o586Wjya-f2ohxYf9C1RlRH-gkrzGS8t', '../YouTube/valid.zip'))
...
os.system(Command(token, '1rWQzZcMskgpEQOZdJPJ7eTmLCBEIIpEN', '../YouTube/all_frames/valid.zip'))
...
os.system(Command(token, '1-QrceIl5sUNTKz7Iq0UsWC6NLZq7girr', '../YouTube2018/valid.zip'))
...
os.system(Command(token, '1yVoHM6zgdcL348cFpolFcEl4IC1gorbV', '../YouTube2018/all_frames/valid.zip'))
